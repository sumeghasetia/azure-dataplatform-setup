...
Below are the sql scripts that need to be perfomed on SSMS (Link to complete SqlScript - ![Link to file](https://github.com/sumeghasetia/main/azure-dataplatform-setup/sqlScripts/polybase-read.sql) ):
